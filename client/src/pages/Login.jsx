  ...
  return (
    <div className="min-h-screen bg-mall-void" style={{ overflow: "auto" }}>
      ...
      <div className="max-w-sm mx-auto px-4 py-16">
        <h1 className="font-display text-2xl text-mall-text mb-1">Welcome back</h1>
        <p className="text-sm text-mall-muted mb-6">Log in to continue shopping.</p>
        ...
        <p className="text-xs text-mall-muted mt-4">
          No account?{" "}
          <Link to="/register" className="text-mall-glow2 hover:underline">
            Register
          </Link>
        </p>
        <p className="text-[11px] text-mall-muted mt-6">
          Demo login: demo@virtualmall.com / Demo@123
        </p>
      </div>
    </div>
  );
